...
- [M1 "A Sprite Lives" design](docs/design/m1-a-sprite-lives-v7.md) (final, v7). Earlier iterations and the external evaluations that shaped them are alongside it in [`docs/design/`](docs/design/).
