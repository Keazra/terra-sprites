...
- [M1 "A Sprite Lives" design](docs/design/m1-a-sprite-lives-v8.md) (final, v8). Earlier iterations and the external evaluations that shaped them are alongside it in [`docs/design/`](docs/design/).
